            ...
            <main className="flex justify-center px-4 py-16">
                <div className="w-full max-w-md text-center">
                    ...
                    <div className="mb-8">
                        ...
                        <label className="mx-auto flex h-24 w-24 cursor-pointer items-center justify-center rounded-full border border-dashed border-white/30 transition hover:border-white/60">
                            <input
                                type="file"
                                accept="image/*"
                                className="hidden"
                    ...
                    <div className="space-y-3">
                        <button className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#5865F2] py-2 text-sm font-medium transition hover:brightness-110">
                            Continue with Discord
                        </button>

                        <button className="flex w-full items-center justify-center gap-2 rounded-lg bg-white py-2 text-sm font-medium text-black transition hover:bg-gray-100">
